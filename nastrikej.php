...
add_action('widgets_init', 'registerNastrikejCompetitions');
add_action('widgets_init', 'registerNastrikejPositions');

function registerNastrikejCompetitions() {
    return register_widget('nastrikejCompetitions');
}
function registerNastrikejPositions() {
    return register_widget('nastrikejPositions');
}
